<div id="mainBody">
	...
	<div id="mainRight">
		...
		<div class="rightContent" >  <!--- Actual Body content --->
			...
			<h5 class="rubricHeading"><em><span>TER On-Line Reports</span></em></h5>
      <p>
      <cfoutput><img class='rightImg' src='#Application.Settings.ImageBaseLogos#/ieir_logo_200px.gif' /></cfoutput>
			<h5 class="rubricDef">TER: <em><span>Summary Report</span></em></h5>
			<br />
      <cfinvoke
      	component="script.ter_rpt" method="getTERCount" returnvariable="terCount">
      </cfinvoke>
      <cfinvoke
      	component="script.ter_rpt" method="getBaselineCount" returnvariable="baselineCount">
      </cfinvoke>
      <cfinvoke
      	component="script.ter_rpt" method="getCapstoneCount" returnvariable="capstoneCount">
      </cfinvoke>
      <cfinvoke
      	component="script.ter_rpt" method="getMeasureableCount" returnvariable="measureableCount">
      </cfinvoke>
      <cfinvoke
      	component="script.ter_rpt" method="getMeasureableCohorts" returnvariable="cohortInfo">
      </cfinvoke>
      <cfinvoke
      	component="script.ter_rpt" method="getBaselineCohorts" returnvariable="baselineInfo">
      </cfinvoke>
      <cfinvoke
      	component="script.ter_rpt" method="getCapstoneCohorts" returnvariable="capstoneInfo">
      </cfinvoke>
			
      <table class="reportsSum">
        <tr>
          <td width='175'>TER Scores In System:</td>
          <td align="left"><cfoutput>#terCount.count#</cfoutput></td>
        </tr>
        <tr>
      ...
      <p>
			<h5 class="rubricDef">TER: <em><span>QEP Reportable</span></em></h5>
      <table class="reports">
        <tr valign="baseline">
      ...
      for whom the system is currently showing both a baseline and a capstone TER score.
      </p>

      <p>
			<h5 class="rubricDef">TER: <em><span>Baselines by Cohort</span></em></h5>
      <table class="reports">
        <tr>
          <th width="140">Cohort Start Term</th>
          <th width="100">Cohort Size</th>
      ...
      <p>
			<h5 class="rubricDef">TER: <em><span>Capstones by Cohort</span></em></h5>
      <table class="reports">
        <tr>
          <th width="140">Cohort Start Term</th>
          <th width="100">Cohort Size</th>
