<div id="mainBody">
	...
	<div id="mainRight">
		...
		<div class="rightContent" >  <!--- Actual Body content --->
			...
			<h5 class="rubricHeading"><em><span>Accuplacer On-Line Reports</span></em></h5>
      <p>
      <cfoutput><img class='rightImg' src='#Application.Settings.ImageBaseLogos#/ieir_logo_200px.gif' /></cfoutput>
			<h5 class="rubricDef">Accuplacer: <em><span>Summary Report</span></em></h5>
			<br />
      <cfinvoke
      	component="script.acp_rpt" method="getACPCount" returnvariable="acpCount">
      </cfinvoke>
      <cfinvoke
      	component="script.acp_rpt" method="getBaselineCount" returnvariable="baselineCount">
      </cfinvoke>
      <cfinvoke
      	component="script.acp_rpt" method="getCapstoneCount" returnvariable="capstoneCount">
      </cfinvoke>
      <cfinvoke
      	component="script.acp_rpt" method="getMeasureableCount" returnvariable="measureableCount">
      </cfinvoke>
      <cfinvoke
      	component="script.acp_rpt" method="getMeasureableCohorts" returnvariable="cohortInfo">
      </cfinvoke>
      <cfinvoke
      	component="script.acp_rpt" method="getBaselineCohorts" returnvariable="baselineInfo">
      </cfinvoke>
      <cfinvoke
      	component="script.acp_rpt" method="getCapstoneCohorts" returnvariable="capstoneInfo">
      </cfinvoke>
			
      <table class="reportsSum">
        <tr>
          <td width='175'>Accuplacer Scores In System:</td>
          <td align="left"><cfoutput>#acpCount.count#</cfoutput></td>
        </tr>
        <tr>
          <td>Baseline Scores In System:</td>
          <td><cfoutput>#baselineCount.count#</cfoutput></td>
        </tr>
        <tr>
          <td>Capstone Scores In System:</td>
      ...
      that have both baseline and capstone TER Scores recorded.<br />&nbsp;<br /></p>
			<p>
			<h5 class="rubricDef">Accuplacer: <em><span>QEP Reportable</span></em></h5>
      <table class="reports">
        <tr valign="baseline">
      ...
      for whom the system is currently showing both a baseline and a capstone Accuplacer score.
      </p>
      <p>
			<h5 class="rubricDef">Accuplacer: <em><span>Baselines By Cohort</span></em></h5>
      <table class="reports">
        <tr>
          <th width="140">Cohort Start Term</th>
          <th width="100">Cohort Size</th>
      ...
      <p>
			<h5 class="rubricDef">Accuplacer: <em><span>Capstones by Cohort</span></em></h5>
      <table class="reports">
        <tr>
          <th width="140">Cohort Start Term</th>
          <th width="100">Cohort Size</th>
