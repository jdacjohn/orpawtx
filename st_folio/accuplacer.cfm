...
<div id="mainRight">
  <div class="rightContent" >
    ...
    <h5 class="rubricHeading"><em><span>AccuPlacer Testing</span></em></h5>
    <p> <cfoutput><img class='rightImg' src='#Application.Settings.ImageBaseLogos#/ieir_logo_200px.gif' /></cfoutput> Vestibulum luctus dolor a orci. Nulla at mi. Nam volutpat. Phasellus tempor. Nulla facilisi. Etiam ac mauris. 
  ...
  <div id="mainLeft">
    ...
    <div class="leftNavContainer" >
      <h4 class="blue principles">AccuPlacer</h4>
