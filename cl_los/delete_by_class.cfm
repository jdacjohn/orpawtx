...
<div id="loMainRight">
    ...
    <cfelse>
		...
		<h5 class="blueback">Delete Course Learning Outcomes for: #theClass#</h5>
    ...
    Delete the outcome by clicking on the red X next to it. If you have not
    entered a class, enter one into the form below and click the 'Search' button.
			<table class="cloSummaryTable" cellspacing="0" cellpadding="0">
				<cfform name="lo_entry_f" id="lo_entry_f" enctype="multipart/form-data" action="./index.cfm?Action=CL_LOS_Delete_Class" method="post" format="html">
        <tr>
        ...
        <table class="cloSummaryTable" cellspacing="0" cellpadding="0">
          ...
          <cfset outcomeCount += 1>
            <tr>
              ...
              <td width="25"><a href="./index.cfm?action=CL_LOS_Delete_Outcome&loid=#outcomes.loid#&disc=#theClass#" title="Remove Outcome"><img #Application.Settings.RemoveImg# /></a></td>
