<cfinvoke component="script.cl_los" method="getDisciplines" returnvariable="activeDisciplines"></cfinvoke>
...
<cfoutput>
	<cfloop query="activeDisciplines">
		<!--- Restricted user case --->
   	<cfif super eq 0>
			<cfif listfind(AvailableActions,actionQ.ActionID) neq 0>
				<li><a href="./index.cfm?action=#Action#&disc=#activeDisciplines.prog#&pid=#activeDisciplines.pid#">#activeDisciplines.prog#</a></li>
      </cfif>
    </cfif>
    <cfif super eq 1>
			<li><a href="./index.cfm?action=#Action#&disc=#activeDisciplines.prog#&pid=#activeDisciplines.pid#">#activeDisciplines.prog#</a></li>
