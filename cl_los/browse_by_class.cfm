...
<div id="loMainRight">
    ...
    <cfelse>
		...
		<h5 class="blueback">Course Learning Outcomes for: #theClass#</h5>
    ...
    entered a class, enter one into the form below and click the 'Search' button.
			<table class="cloSummaryTable" cellspacing="0" cellpadding="0">
				<cfform name="lo_entry_f" id="lo_entry_f" enctype="multipart/form-data" action="./index.cfm?Action=CL_LOS_Browse_Class" method="post" format="html">
        <tr>
