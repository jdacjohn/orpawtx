      ...
      <cfelse>
      	<cfset theClass = ''>
			...
			<table class="cloSummaryTable" cellspacing="0" cellpadding="0">
				<cfform name="lo_entry_f" id="lo_entry_f" enctype="multipart/form-data" action="./index.cfm?Action=CL_LOS_Edit_Rubric&rubric=#rubric#" method="post" format="html">
        <tr>
          <td width="100">
        ...
        <table class="cloSummaryTable" cellspacing="0" cellpadding="0">
          ...
          <cfset outcomeCount += 1>
            <tr>
              ...
              <td width="25"><a href="./index.cfm?action=CL_LOS_Edit_Outcome&loid=#outcomes.loid#&disc=#selClass#" title="Edit Outcome"><img #Application.Settings.EditImg# /></a></td>
