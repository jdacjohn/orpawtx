...
<h5 class="blueback"><a href="./index.cfm?action=CL_LOS_Admin_Add&loid=#loid#">#outcome_q.loShortName#</a> - Student Learning Outcome:  New Assessment Measure</h5>
<p>
<hr width="100%" />
<table class="loCreateTable" cellspacing="0" cellpadding="0">
<cfform name="am_entry_f" id="am_entry_f" action="./index.cfm?Action=CL_LOS_SubmitMeasure_DB" method="post" format="html">
