...
<cfoutput>
<h5 class="blueback">&nbsp;Course Learning Outcome - Edit Assessment Measures - <a href="./index.cfm?action=CL_LOS_Edit_Outcome&loid=#theLO#&disc=#disc#" title="Return to Outcome">#theOutcome.loName#</a></h5>
...
<table class="cloSummaryTable" cellspacing="0" cellpadding="0">
  ...
  <cfform name="#('editMeasure' & measureCount)#" id="#('editMeasure' & measureCount)#" action="./index.cfm?Action=CL_LOS_Edit_UpdateMeasure_DB" method="post" format="html">
  ...
  <tr>
    <td colspan="2"><h5 class="blueback"><span style="text-decoration:underline">Measurement Criteria #measureCount#</span>&nbsp;<a href="index.cfm?action=CL_LOS_Edit_Xmeasure&lomid=#measures.lomid#&loid=#theLO#&disc=#disc#">Delete</a></h5></td>
  </tr>
  <tr>
