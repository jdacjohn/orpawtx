...
<cfoutput>
<h5 class="blueback">&nbsp;Course Learning Outcome - #theOutcome.loName# - <a href="./index.cfm?action=CL_LOS_Browse_DISC&disc=#disc#" title="Return to #disc# Outcomes">#disc#</a></h5>
...
<!---  <tr>
  ...
  <tr>
    <td colspan="2"><h5 class="blueback"><span style="text-decoration:underline">Measurement Criteria for Activity:</span>:&nbsp;&nbsp; #measures.lomDescription#</h5></td>
  </tr>
