...
<cfoutput>
<h5 class="blueback">&nbsp;Course Learning Outcome - <a href="./index.cfm?action=CL_LOS_Edit_Outcome&loid=#theLO#&disc=#disc#" title="Return to Outcome">#theOutcome.loName#</a></h5>
...
<!---  <tr>
  ...
  <tr>
    <td colspan="2"><h5 class="blueback"><span style="text-decoration:underline">Measurement Criteria</span>:&nbsp;&nbsp;Activity #measures.lomDescription#</h5></td>
  </tr>
