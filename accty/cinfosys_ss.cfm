<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
      ...
      <h5 class="rubricHeading"><em><span>Accountability Measures - Consumer Information Systems: Student Success</span></em></h5>
  ...
  <div id="mainLeft">
    ...
    <div class="leftNavContainer" >
      <h4 class="blue principles">CIS Components</h4>
      <div class="navVertContainer">
        <ul>
          <cfinclude template="cis_links.cfm">
        </ul>
      </div>
    </div>
    <!-- ACE NAV END -->
