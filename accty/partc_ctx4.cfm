<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
      ...
      <h5 class="rubricHeading"><em><span>Accountability Standards - Non-funded and Non-reported State College Activities</span></em></h5>
  ...
  <div id="mainLeft">
    ...
    <div class="leftNavContainer" >
      ...
      <div class="navVertContainer">
        <ul>
          <cfinclude template="partc_ctx_links.cfm">
        </ul>
      </div>
    </div>
    <!--- CTX NAV END --->
