<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
      ...
      <h5 class="rubricHeading"><em><span>Accountability Standards - Institutional Efficiencies & Effectiveness Contextual Measures</span></em></h5>
  ...
  <div id="mainLeft">
   ...
   <div class="leftNavContainer" >
      ...
      <div class="navVertContainer">
        <ul>
          <cfinclude template="iee_ctx_links.cfm">
        </ul>
      </div>
    </div>
    <!--- CTX NAV END --->
