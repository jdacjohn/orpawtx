<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
      ...
      <h5 class="rubricHeading"><em><span>Accountability Standards - Institutional Efficiencies & Effectiveness Key Measures</span></em></h5>
  ...
  <div id="mainLeft">
    ...
    <div class="leftNavContainer" >
      <h4 class="blue principles">Key Measures</h4>
      <div class="navVertContainer">
        <ul>
          <cfinclude template="iee_key_links.cfm">
        </ul>
      </div>
    </div>
    ...
    <!--- Key Measures NAV --->
    <div class="leftNavContainer" >
      <h4 class="blue principles">IE&E</h4>
      <div class="navVertContainer">
        <ul>
          <cfinclude template="iee_links.cfm">
        </ul>
      </div>
    </div>
    <!--- key measures NAV END --->
