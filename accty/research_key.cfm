<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
      ...
      <h5 class="rubricHeading"><em><span>Accountability Standards - Research Key Measures</span></em></h5>
  ...
  <div id="mainLeft">
    ...
    <!--- Key Measures NAV --->
    <div class="leftNavContainer" >
      <h4 class="blue principles">Research</h4>
      <div class="navVertContainer">
        <ul>
          <cfinclude template="rsrch_links.cfm">
        </ul>
      </div>
    </div>
    <!--- key measures NAV END --->
