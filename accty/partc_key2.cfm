<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
      ...
      <h5 class="rubricHeading"><em><span>Accountability Standards - Annual Unduplicated Enrollment</span></em></h5>
  ...
  <div id="mainLeft">
    ...
    <div class="leftNavContainer" >
      ...
      <div class="navVertContainer">
        <ul>
          <cfinclude template="partc_key_links.cfm">
        </ul>
      </div>
    </div>
    ...
    <!--- Key Measures NAV --->
    <div class="leftNavContainer" >
      <h4 class="blue principles">Participation</h4>
      <div class="navVertContainer">
        <ul>
          <cfinclude template="partc_links.cfm">
        </ul>
      </div>
    </div>
    <!--- key measures NAV END --->
