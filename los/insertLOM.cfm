...
<cfinvoke component='script.los' method='insertLOM' lomData=#lomdata# returnvariable='amID'></cfinvoke>
<!--- Criteria now --->
<cfset ratingData = StructNew()>
<cfset ratingData.lomId = amID>
<cfset ratingData.score = 1>
<cfset ratingData.criteria = trim(lomRateBeg)>
<cfinvoke component='script.los' method='insertLOMR' lomrData=#ratingData# returnVariable='lomrId'></cfinvoke>
<cfset ratingData = StructNew()>
<cfset ratingData.lomId = amID>
...
<br />
<cflocation url="./index.cfm?action=LOS_Admin&major=#major#&p_id=#p_id#" />
</cfoutput>
</div>
