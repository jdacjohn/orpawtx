...
<div id="loMainRight">
      ...
      #Application.Settings.SiteContactEmail#<br />
		<cfelse>
  		...
  		<cfinvoke component='script.los' method='countMeasures' loid=#outcomes.loid# returnvariable='measureCount'></cfinvoke>
      		...
      		<td width="50" align="center">&nbsp;<cfif outcomes.lo_pdf neq ''><a href="./los/files/#outcomes.lo_pdf#" target="_blank" title="Get PDF"><img #Application.Settings.PDFImg# /></a></cfif></td>
    ...
    <cfloop query="groups">&nbsp;<a href="./index.cfm?action=LOS_Entry&major=#major#&p_id=#p_id#&term=#groups.agTerm#" title="View Term Assignments">#groups.agTerm#</a>&nbsp;</cfloop>
    <a href="./index.cfm?action=LOS_Entry&major=#major#&p_id=#p_id#&showall=1" title="View ALL Assignments">Show All</a>
    </h5>
    <cfif isDefined('showall')>
      <cfloop query='groups'>
        ...
        <table class="loSummaryTable" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><cfif togo gt 0><a href="./index.cfm?action=LOS_EnterRubric&loag=#aGroups.loa_group_id#&major=#major#&p_id=#p_id#" title="Enter Assessments">#aGroups.class#</a><cfelse><a title="All Assessments are Complete">#aGroups.class#</a></cfif></td>
