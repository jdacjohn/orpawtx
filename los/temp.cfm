...
<div id="loMainRight">
      ...
      #Application.Settings.SiteContactEmail#<br />
		<cfelse>
  		...
  		<cfinvoke component='script.los' method='countMeasures' loid=#outcomes.loid# returnvariable='measureCount'></cfinvoke>
  			<tr>
    			<td width="150"><b>#outcomes.loShortName#</b></td>
      		<td width="50" style="border-left: 1px solid" align="center">&nbsp;<cfif outcomes.lo_pdf neq ''><a href="./los/files/#outcomes.lo_pdf#" target="_blank">PDF</a></cfif></td>
      		<td width="100" style="border-left: 1px solid">&nbsp;<cfif measureCount eq 0><span style="color:##FF0000">Measures</span><cfelse>Measures</cfif> (#measureCount#)</td>
      		<td width="40"><cfif measureCount gt 0><a href="./index.cfm?action=LOS_ViewMeasures_RO&loid=#outcomes.loid#&prog=#major#">View</a></cfif></td>
      		<td width="30" align="left">&nbsp;</td>
      		<td width="220" style="border-left: 1px solid;">&nbsp;</td>
    		</tr>
  		</cfloop>
  		</table>
		</cfif>
    ...
    <cfloop query="groups">&nbsp;<a href="./index.cfm?action=LOS_Browse&major=#major#&p_id=#p_id#&term=#groups.agTerm#">#groups.agTerm#</a>&nbsp;</cfloop>
    <a href="./index.cfm?action=LOS_Browse&major=#major#&p_id=#p_id#&showall=1">Show All</a>
    </h5>
    ...
    <cfelse>
      ...
      <table class="loSummaryTable" cellspacing="0" cellpadding="0">
        ...
        <cfset togo = aGroups.enrolled - assessments.count>
        <tr>
          <td><a href="./index.cfm?action=LOS_EnterRubric&loag=#aGroups.loa_group_id#">#aGroups.class#</a></td>
          <td>#q_lo.loShortName#</td>
          <td>#aGroups.lo_level#</td>
          <td>#aGroups.enrolled#</td>
          <td>#assessments.count#</td>
      ...
      <p>To Enter a learning outcome rubric, click on a class link above.</p>
		</cfif>
		</cfoutput>
		</div>
	<cfelse>
		<div class="rightContent">  
			<p>Welcome to the On-line Rubrics Entry System for Student Learning Outcomes.<br />&nbsp;<br />
      Please select a program from the list on the left to begin.</p>
    </div>
	</cfif>
