...
<cfinvoke component='script.registration' method='regPeriod' regTerm="#Application.Settings.RegTerm#" returnVariable='reportDates'></cfinvoke>
...
<cfoutput>Ndx = #ndx#<br /></cfoutput>
  ...
  <cfif currentMonth neq months[ndx]>
    ...
    <!--- Start a new month --->
  	<cfoutput><br />
		<table border="0" cellspacing="0" cellpadding="0" width="200" height="150">
			<tr><th colspan="7" align="center">#MonthAsString(months[ndx])# #years[ndx]#</th></tr>
   		<tr>
   			<cfloop index="x" from="1" to="7">
      		<th>#Left(dayOfWeekAsString(x),1)#</th>
   			</cfloop>
   		</tr>
    </cfoutput>
...
<cfoutput>Counter = #counter#<br /></cfoutput>
  ...
  <cfoutput>Day Count = #dayCount#<br /></cfoutput>
    ...
    <cfif dayCount lt day(reportDates[x].rptDate)>
		...
		<cfoutput><td align="center"><a href="http://#reportDates[x].sequence#">#day(reportDates[x].rptDate)#</a></td></cfoutput>
   	<cfset counter += 1>
   	<cfif counter is 8>
   		<cfoutput></tr></cfoutput>
