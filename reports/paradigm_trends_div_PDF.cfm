...
<cfform name="TrendVars" id="trendVars" enctype="multipart/form-data" action="./index.cfm?Action=Reports_CoreInd_Div" method="post" format="html">
  <tr>
  	<th width="150" style="font-family: Verdana, Helvetica, Arial, sans-serif;font-size: 11px;">Instructional Division</th>
  	<td>
...
<cfinvoke component='script.trends' method='unDupHCLast5Div' excludeDC='#noDC#' division='#theDiv#' returnVariable='aUndupHC'></cfinvoke>
<cfinvoke component='script.trends' method='completersLast5Div' excludeDC='#noDC#' division='#theDiv#' returnVariable='aCompleters'></cfinvoke>
<cfinvoke component='script.trends' method='placementsLast5Div' excludeDC='#noDC#' division='#theDiv#' returnVariable='aPlacements'></cfinvoke>
...
<cfchart format="jpg" title="#chartTitle#" showlegend="yes">
...
<cfoutput>
<cfform name="filter" id="filterDC" action="./index.cfm?action=Reports_CoreInd_Div" method="post" format="html">
