...
<cfinvoke component='script.terms' method='getAcadYear' terms='#term#' returnVariable='theYear'></cfinvoke>
<h5 class="termReports"><em><span>Course Section Grade Distribution - TSTC #college#</span></em></h5>
<p></p>

<cfset theTerm=''>
<h5 class="termReports"><em><span>#theYear# Course Pass/Fail Rates for #course#</span></em></h5>
...
<table class="csTable">
  ...
  <cfinvoke component='script.courses' method='getMultipleCourseDropFailRates' terms='#term#' course='#course#' loc=#loc# returnVariable='theCourse'></cfinvoke>
  <tr>
...
<cfinvoke component="script.courses" method="getMultipleGradeDistributions" terms='#term#' course='#course#' loc=#loc# returnvariable='sections'></cfinvoke>
...
<table class="csTable">
  ...
  <cfloop index="ndx" from="1" to="#ArrayLen(sections)#" step="1">
    <tr>
      ...
      <td>#sections[ndx].term#
      <td>#sections[ndx].iName#,&nbsp;#sections[ndx].iFInit#</h3></td>
