...
<cfform name="TrendVars" id="trendVars" enctype="multipart/form-data" action="./index.cfm?Action=Reports_CoreInd_Prog" method="post" format="html">
  <tr>
  	<th width='150' style="font-family: Verdana, Helvetica, Arial, sans-serif;font-size: 11px;">Instructional Program</th>
  	<td>
...
<cfinvoke component='script.trends' method='unDupHCLast5Prog' excludeDC='#noDC#' program='#theProg#' returnVariable='aUndupHC'></cfinvoke>
<cfinvoke component='script.trends' method='completersLast5Prog' excludeDC='#noDC#' program='#theProg#' returnVariable='aCompleters'></cfinvoke>
<cfinvoke component='script.trends' method='placementsLast5Prog' excludeDC='#noDC#' program='#theProg#' returnVariable='aPlacements'></cfinvoke>
