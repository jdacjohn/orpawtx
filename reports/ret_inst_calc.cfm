<div id="mainBody">
  ...
  <div id="mainRight">
    <div class="rightContent" >
		<cfparam name="fall" default="0">
    <cfparam name="sem" default="0">
		<cfoutput>
      <h4 class="blue instructional">TSTC West Texas Institutional Effectiveness & Information Research</h4>
      <h5 class="rubricHeading"><em><span>Institutional Retention Calculations: <cfif fall EQ 1>Annual Cohorts</cfif><cfif sem EQ 1>Semester Cohorts</cfif></span></em></h5>
  ...
  <div id="mainLeft">
    ...
    <h4 class="blue comm">Retention Span</h4>
      ...
      <form name="cform" method="post" action="index.cfm?action=RTC_Inst_Display"  enctype="multipart/form-data">
        ...
        <tr><td><input type="radio" name="respan" value="fa2fa" onClick="javascript:hideList('sm2smList');showList('fa2faList');"/> Fall to Fall</td></tr>
        <tr><td><input type="radio" name="respan" value="sm2sm" onClick="javascript:hideList('fa2faList');showList('sm2smList');"/> Semester to Semester</td></tr>
        <tr><td><input type="checkbox" name="byloc" /> Show by Campus</td></tr>
        <tr id="fa2faList" style="display: none">
          <td width="100%">
        ...
        <tr id="sm2smList" style="display: none">
          <td width="100%">
            <table class="retTable" style="border: 1px solid #142855;">
