...
<!--- Debug nav info --->
<cfoutput>
Action value in ./reports/index.cfm = #Action# <br />
</cfoutput>
...
<CFSWITCH EXPRESSION="#Action#">
  ...
  <cfcase value="Reports_Home">
	...
	<cfcase value="Reports_CoreInd">
  	<cfinclude template="./coreinds.cfm">
  </cfcase>
	<cfcase value="Reports_Retention">
  	<cfinclude template="./retain.cfm">
  </cfcase>
	<cfcase value="Reports_Grads">
  	<cfinclude template="./gradrates.cfm">
  </cfcase>
	<cfcase value="Reports_Demog">
  	<cfinclude template="./sdemo.cfm">
  </cfcase>
  <!--- Retention Pages --->
  <cfcase value="Retention_Defs">
  	<cfinclude template="retentdefs.cfm">
  </cfcase>
