...
<cfform name="TrendVars" id="trendVars" enctype="multipart/form-data" action="./index.cfm?Action=Reports_CoreInd_Loc" method="post" format="html">
  <tr>
    <th width='150' style="font-family: Verdana, Helvetica, Arial, sans-serif;font-size: 11px;">Instructional Location</th>
  	<td>
...
<cfinvoke component='script.trends' method='unDupHCLast5Loc' excludeDC='#noDC#' location='#theLoc#' returnVariable='aUndupHC'></cfinvoke>
<cfinvoke component='script.trends' method='completersLast5Loc' excludeDC='#noDC#' location='#theLoc#' returnVariable='aCompleters'></cfinvoke>
<cfinvoke component='script.trends' method='placementsLast5Loc' excludeDC='#noDC#' location='#theLoc#' returnVariable='aPlacements'></cfinvoke>
