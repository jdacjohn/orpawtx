...
<cfif isdefined('major')>
	<h5 class="rubricHeading"><em><span>All Application Details</span></em> for <cfoutput>#major# for the #campus.campus# Campus.</cfoutput></h5>
<cfelse>  
	<h5 class="rubricHeading"><em><span>All Application Details</span></em> for <cfoutput>all majors for the #campus.campus# Campus.</cfoutput></h5>
</cfif>  

<cfif isdefined('major')>
  <cfinvoke component='script.em' method='getAllApps' major='#major#' location=#loc# returnvariable='getNew'></cfinvoke>
  <cfoutput>
...
<cfelse>
  <cfinvoke component='script.em' method='getAllAppsForLoc' location=#loc# returnvariable='allMajors'></cfinvoke>
  <cfoutput>
